...
function Set-AzMigrateDiskMapping {
    [OutputType([Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20230101.IVMwareCbtUpdateDiskInput])]
    ...
    process {
        $DiskObject = [Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20230101.VMwareCbtUpdateDiskInput]::new()
