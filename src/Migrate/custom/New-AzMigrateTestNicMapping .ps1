...
function New-AzMigrateTestNicMapping {
    [OutputType([Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20230101.IVMwareCbtNicInput])]
    ...
    process {
        $NicObject = [Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20230101.VMwareCbtNicInput]::new()
