...
function Set-AzMigrateServerReplication {
    [OutputType([Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20230101.IJob])]
    ...
    param(
        ...
        [Microsoft.Azure.PowerShell.Cmdlets.Migrate.Category('Path')]
        [Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20230101.IMigrationItem]
        ...
        [Parameter()]
        [Microsoft.Azure.PowerShell.Cmdlets.Migrate.Category('Path')]
        [Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20230101.IVMwareCbtNicInput[]]
        # Updates the NIC for the Azure VM to be created.
        ${NicToUpdate},

        [Parameter()]
        [Microsoft.Azure.PowerShell.Cmdlets.Migrate.Category('Path')]
        [Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20230101.IVMwareCbtUpdateDiskInput[]]
        ...
        [Parameter()]
        [Microsoft.Azure.PowerShell.Cmdlets.Migrate.Category('Path')]
        [Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20230101.IVMwareCbtEnableMigrationInputTargetVmtags]
        ...
        [Parameter()]
        [Microsoft.Azure.PowerShell.Cmdlets.Migrate.Category('Path')]
        [Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20230101.IVMwareCbtEnableMigrationInputTargetNicTags]
        ...
        [Parameter()]
        [Microsoft.Azure.PowerShell.Cmdlets.Migrate.Category('Path')]
        [Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20230101.IVMwareCbtEnableMigrationInputTargetDiskTags]
    ...
    process {
        ...
        if ($ReplicationMigrationItem -and ($ReplicationMigrationItem.ProviderSpecificDetail.InstanceType -eq 'VMwarecbt')) {
            $ProviderSpecificDetails = [Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20230101.VMwareCbtUpdateMigrationItemInput]::new()
            ...
            if ($HasDiskToUpdate) {
                ...
                if ($changeOsDiskId -ne $null -and $changeOsDiskId -ne $previousOsDiskId) {
                    if ($diskIdDiskTypeMap.ContainsKey($previousOsDiskId)) {
                        ...
                        $updateDisk = [Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20230101.VMwareCbtUpdateDiskInput]::new()
            ...
            if ($HasTargetDiskName) {
                ...
                [Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20230101.IVMwareCbtUpdateDiskInput[]]$updateDisksArray = @()
                $originalDisks = $ReplicationMigrationItem.ProviderSpecificDetail.ProtectedDisk
                foreach ($DiskObject in $originalDisks) {
                    if ( $DiskObject.IsOSDisk) {
                        $updateDisk = [Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20230101.VMwareCbtUpdateDiskInput]::new()
            ...
            [Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20230101.IVMwareCbtNicInput[]]$updateNicsArray = @()
            ...
            foreach ($storedNic in $originalNics) {
                $updateNic = [Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20230101.VMwareCbtNicInput]::new()
